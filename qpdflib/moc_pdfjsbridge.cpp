...
void PdfJsBridge::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (PdfJsBridge::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PdfJsBridge::initialized)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (PdfJsBridge::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PdfJsBridge::pdfDocumentloaded)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject PdfJsBridge::staticMetaObject = {
    { &QWebEngineView::staticMetaObject, qt_meta_stringdata_PdfJsBridge.data,
      qt_meta_data_PdfJsBridge,  qt_static_metacall, nullptr, nullptr}
};
...
void *PdfJsBridge::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PdfJsBridge.stringdata0))
        return static_cast<void*>(const_cast< PdfJsBridge*>(this));
...
const QMetaObject BridgeObject::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_BridgeObject.data,
      qt_meta_data_BridgeObject,  qt_static_metacall, nullptr, nullptr}
};
...
void *BridgeObject::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_BridgeObject.stringdata0))
        return static_cast<void*>(const_cast< BridgeObject*>(this));
