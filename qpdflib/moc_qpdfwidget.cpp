...
void QPdfWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (QPdfWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QPdfWidget::initialized)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QPdfWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QPdfWidget::pdfDocumentLoaded)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject QPdfWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QPdfWidget.data,
      qt_meta_data_QPdfWidget,  qt_static_metacall, nullptr, nullptr}
};
...
void *QPdfWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QPdfWidget.stringdata0))
        return static_cast<void*>(const_cast< QPdfWidget*>(this));
